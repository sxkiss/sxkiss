...
MyPrint "- ③ 更改云端仓库地址：https://github.com/sxkiss/sxkiss/tree/master/Third_Party_Redirect"
...
MyPrint "- [1] 同步云端数据"
MyPrint "- [2] 后台更新无需重启"
MyPrint "- [3] 复制开源仓库: https://github.com/sxkiss/sxkiss/tree/master/Third_Party_Redirect"
MyPrint " "
